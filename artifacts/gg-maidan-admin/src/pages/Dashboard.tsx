...
import { clearToken, listAdminTournaments, AdminTournament } from '@/lib/api';
...
type SectionId = 'announcements' | 'tournaments' | 'news' | 'sponsors' | 'registrations';
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 md:ml-56 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-4 md:p-6 max-w-6xl w-full mx-auto">
          ...
          {section === 'tournaments'    && <TournamentsSection tournaments={tournaments} onRefresh={loadTournaments} />}
          {section === 'news'           && <NewsSection />}
          {section === 'sponsors'       && <SponsorsSection />}
          {section === 'registrations'  && <RegistrationsSection tournaments={tournaments} />}
        </main>
      </div>
    </div>
  );
